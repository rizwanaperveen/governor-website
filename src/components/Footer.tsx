...
const Footer = () => {
  return (
    <div className='sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-10 py-8 bg-slate-300 h-full w-full max-sm:8 flex'>
        <div className='p-8 text-slate-900m-4 sm:m-1'>
